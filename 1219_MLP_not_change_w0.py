...
class layer:
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1219_MLP_not_change_w0", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1219_MLP_not_change_w0_2"
    training = True
    testing = False
    ...
    for i in range(layer_num + 1):
        ax.plot(graph_x, graph_y[i], linewidth=1.0, marker=".", markersize=5)
        ax.plot(graph_x, graph_train_y[i], linewidth=1.0, marker=".", markersize=5)
    ax.grid(which="both")
    ax.set_xlabel("epoch")
    ax.set_ylabel("accuracy")
    plt.title(str(train_size))
