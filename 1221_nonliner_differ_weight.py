...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('feed_forword'):
            ...
            """
            hidden_1_8 = tf.layers.batch_normalization(hidden_8, training=training)
            hidden_1_7 = tf.layers.batch_normalization(hidden_8 + hidden_7, training=training) / 1
            hidden_1_6 = tf.layers.batch_normalization(hidden_8 + hidden_7 + hidden_6, training=training) / 1
            hidden_1_5 = tf.layers.batch_normalization(hidden_8 + hidden_7 + hidden_6 + hidden_5, training=training) / 1
            hidden_1_4 = tf.layers.batch_normalization(
                hidden_8 + hidden_7 + hidden_6 + hidden_5 + hidden_4, training=training) / 1
            """
            hidden_1_8 = tf.nn.relu(tf.layers.batch_normalization(hidden_8 + b1_8, training=training))
            hidden_1_7 = tf.nn.relu(tf.layers.batch_normalization(hidden_7 + b1_7, training=training) + hidden_1_8)
            hidden_1_6 = tf.nn.relu(tf.layers.batch_normalization(hidden_6 + b1_6, training=training) + hidden_1_7)
            hidden_1_5 = tf.nn.relu(tf.layers.batch_normalization((hidden_8 + hidden_5) + b1_5, training=training))

            hidden_1_4 = tf.layers.batch_normalization(
                hidden_8 + hidden_7 + hidden_6 + hidden_5 + hidden_4, training=training) / 1
            hidden_1_3 = tf.layers.batch_normalization(
                hidden_8 + hidden_7 + hidden_6 + hidden_5 + hidden_4 + hidden_3, training=training) / 1
            hidden_1_2 = tf.layers.batch_normalization(
                hidden_8 + hidden_7 + hidden_6 + hidden_5 + hidden_4 + hidden_3 + hidden_2, training=training) / 1

            p0 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_8, w0) + b0, training=training))
            p1 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_7, w0) + b0, training=training))
            p2 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_6, w0) + b0, training=training))
            p3 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_5, w0) + b0, training=training))
            p4 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_4, w0) + b0, training=training))
            p5 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_3, w0) + b0, training=training))
            p6 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_2, w0) + b0, training=training))

            """
            with tf.name_scope('p0'):
                hidden_1_8 = tf.nn.relu((tf.layers.batch_normalization(hidden_8,
                                                                       training=training) + b1))
                p0 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_8, w0) + b0))
            with tf.name_scope('p1'):
                hidden_1_7 = tf.nn.relu((tf.layers.batch_normalization(hidden_8 + hidden_7,
                                                                       training=training)/2 + b1))
                p1 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_7, w0) + b0))
            with tf.name_scope('p2'):
                hidden_1_6 = tf.nn.relu((tf.layers.batch_normalization(hidden_8 + hidden_7 + hidden_6,
                                                                       training=training)/3 + b1))
                p2 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_6, w0) + b0))
            with tf.name_scope('p3'):
                hidden_1_5 = tf.nn.relu((tf.layers.batch_normalization(hidden_8 + hidden_7 + hidden_6 + hidden_5,
            ...
            with tf.name_scope('p4'):
                hidden_1_4 = tf.nn.relu(
                    (tf.layers.batch_normalization(hidden_8 + hidden_7 + hidden_6 + hidden_5 + hidden_4,
            ...
            with tf.name_scope('p5'):
                hidden_1_3 = tf.nn.relu(
                    (tf.layers.batch_normalization(hidden_8 + hidden_7 + hidden_6 + hidden_5 + hidden_4 + hidden_3,
            ...
            with tf.name_scope('p6'):
                hidden_1_2 = tf.nn.relu((tf.layers.batch_normalization(
                    hidden_8 + hidden_7 + hidden_6 + hidden_5 + hidden_4 + hidden_3 + hidden_2,
        ...
        with tf.name_scope('train_step0'):
            ...
            with tf.control_dependencies(update_ops):
                train_step0 = tf.train.AdamOptimizer().minimize(loss0, var_list=[w0, b0, w8, b8, b1_8])
                train_step1 = tf.train.AdamOptimizer().minimize(loss1, var_list=[w0, b0, w7, b7, b1_7])
                train_step2 = tf.train.AdamOptimizer().minimize(loss2, var_list=[w0, b0, w6, b6, b1_6])
                train_step3 = tf.train.AdamOptimizer().minimize(loss3, var_list=[w0, b0, w5, b5, b1_5])
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1221_nonliner_differ_weight", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1221_nonliner_differ_weight_"
    training = True
    testing = False
