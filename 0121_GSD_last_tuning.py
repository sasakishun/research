...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('node_size'):
            ...
            with tf.name_scope('num_units8'):
                num_units8 = int(hidden_unit)  # 2000
                num_units7 = int(hidden_unit)  # 1000
                num_units6 = int(hidden_unit)  # 500
                num_units5 = int(hidden_unit)  # 30
...
if __name__ == '__main__':
    ...
    if dataset_flag == 0:
        np.save("GSD_last_tune_mnist", graph_y)
    if dataset_flag == 1:
        np.save("GSD_last_tune_fashion", graph_y)
    if dataset_flag == 2:
        np.save("GSD_last_tune_cifar10", graph_y)
    if dataset_flag == 3:
        np.save("GSD_last_tune_cifar100", graph_y)
