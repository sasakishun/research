...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('node_size'):
            ...
            with tf.name_scope('num_units8'):
                num_units8 = 2000  # hidden_unit
                num_units7 = 1000  # int(hidden_unit)
                num_units6 = 500  # int(hidden_unit)
                num_units5 = 30  # int(hidden_unit)
...
if __name__ == '__main__':
    ...
    if dataset_flag == 0:
        np.save("original_GSD_mnist", graph_y)
    if dataset_flag == 1:
        np.save("original_GSD_fashion", graph_y)
    if dataset_flag == 2:
        np.save("original_GSD_cifar10", graph_y)
    if dataset_flag == 3:
        np.save("original_GSD_cifar100", graph_y)
