...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('feed_forword'):
            ...
            with tf.name_scope('state1'):
                ...
                with tf.name_scope('p1'):
                    p1 = tf.nn.softmax(tf.matmul(hidden1_1_drop, w0) + b0 + tf.matmul(x, w0_9))
            ...
            with tf.name_scope('state2'):
                ...
                with tf.name_scope('p2'):
                    p2 = tf.nn.softmax(tf.matmul(x, w0_9) + b0 + tf.matmul(hidden2_1_drop, w0))
            ...
            with tf.name_scope('state3'):
                ...
                with tf.name_scope('p3'):
                    p3 = tf.nn.softmax(tf.matmul(x, w0_9) + b0 + tf.matmul(hidden3_1_drop, w0))
            ...
            with tf.name_scope('state4'):
                ...
                with tf.name_scope('p4'):
                    p4 = tf.nn.softmax(tf.matmul(x, w0_9) + b0 + tf.matmul(hidden4_1_drop, w0))
            ...
            with tf.name_scope('state5'):
                ...
                with tf.name_scope('p5'):
                    p5 = tf.nn.softmax(tf.matmul(x, w0_9) + b0 + tf.matmul(hidden5_1_drop, w0))
            ...
            with tf.name_scope('state6'):
                ...
                with tf.name_scope('p6'):
                    p6 = tf.nn.softmax(tf.matmul(x, w0_9) + b0 + tf.matmul(hidden6_1_drop, w0))
            ...
            with tf.name_scope('state7'):
                ...
                with tf.name_scope('p7'):
                    p7 = tf.nn.softmax(tf.matmul(x, w0_9) + b0 + tf.matmul(hidden7_1_drop, w0))
            ...
            with tf.name_scope('state8'):
                ...
                with tf.name_scope('p8'):
                    p8 = tf.nn.softmax(tf.matmul(x, w0_9) + b0 + tf.matmul(hidden8_1_drop, w0))
        ...
        with tf.name_scope('optimizer'):
            ...
            with tf.name_scope('loss2'):
                loss2 = -tf.reduce_sum(t * tf.log(tf.clip_by_value(p2, 1e-10, 1.0))) - tf.reduce_sum(tf.log(w0_9))
            with tf.name_scope('loss3'):
                loss3 = -tf.reduce_sum(t * tf.log(tf.clip_by_value(p3, 1e-10, 1.0))) - tf.reduce_sum(tf.log(w1_9))
            with tf.name_scope('loss4'):
                loss4 = -tf.reduce_sum(t * tf.log(tf.clip_by_value(p4, 1e-10, 1.0))) - tf.reduce_sum(tf.log(w2_9))
            with tf.name_scope('loss5'):
                loss5 = -tf.reduce_sum(t * tf.log(tf.clip_by_value(p5, 1e-10, 1.0))) - tf.reduce_sum(tf.log(w3_9))
            with tf.name_scope('loss6'):
                loss6 = -tf.reduce_sum(t * tf.log(tf.clip_by_value(p6, 1e-10, 1.0))) - tf.reduce_sum(tf.log(w4_9))
            with tf.name_scope('loss7'):
                loss7 = -tf.reduce_sum(t * tf.log(tf.clip_by_value(p7, 1e-10, 1.0))) - tf.reduce_sum(tf.log(w5_9))
            with tf.name_scope('loss8'):
                loss8 = -tf.reduce_sum(t * tf.log(tf.clip_by_value(p8, 1e-10, 1.0))) - tf.reduce_sum(tf.log(w6_9))
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1022_nonliner_add_after_ReLU", sess.graph)
...
if __name__ == '__main__':
    ...
    for j in range(len(nn.train_step)):
        ...
        for i in range(loop_len):
            ...
            nn.sess.run(nn.train_step[j], feed_dict={nn.x: batch_xs, nn.t: batch_ts, nn.keep_prob: 1.0})
            if i % 100 == 0:
