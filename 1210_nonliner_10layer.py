...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('feed_forword'):
            ...
            hidden_1 = tf.nn.relu(tf.matmul(hidden_2, w1) + b1)

            with tf.name_scope('p0'):
                p0 = tf.nn.softmax(tf.matmul(x, w0_9) * gate_9 + b0)

            with tf.name_scope('p1'):
                p1 = tf.nn.softmax(tf.matmul(x, w0_9) * (gate_9)
                                   + b0
                                   + tf.matmul(hidden_8, w0_8) * (gate_8))

            with tf.name_scope('p2'):
                p2 = tf.nn.softmax(tf.matmul(x, w0_9) * (gate_9)
                                   + b0
                                   + tf.matmul(hidden_8, w0_8) * (gate_8)
                                   + tf.matmul(hidden_7, w0_7) * (gate_7))

            with tf.name_scope('p3'):
                p3 = tf.nn.softmax(tf.matmul(x, w0_9) * (gate_9)
                                   + b0
                                   + tf.matmul(hidden_6, w0_6) * (gate_6)
                                   + tf.matmul(hidden_7, w0_7) * (gate_7)
                                   + tf.matmul(hidden_8, w0_8) * (gate_8))
            ...
            with tf.name_scope('p4'):
                p4 = tf.nn.softmax(tf.matmul(x, w0_9 * gate_9)
                                   + b0
                                   + tf.matmul(hidden_5, w0_5) * (gate_5)
                                   + tf.matmul(hidden_6, w0_6) * (gate_6)
                                   + tf.matmul(hidden_7, w0_7) * (gate_7)
                                   + tf.matmul(hidden_8, w0_8) * (gate_8))
            with tf.name_scope('p5'):
                p5 = tf.nn.softmax(tf.matmul(x, w0_9 * gate_9)
                                   + b0
                                   + tf.matmul(hidden_4, w0_4) * gate_4
                                   + tf.matmul(hidden_5, w0_5) * gate_5
                                   + tf.matmul(hidden_6, w0_6) * gate_6
                                   + tf.matmul(hidden_7, w0_7) * gate_7
                                   + tf.matmul(hidden_8, w0_8) * gate_8)
            ...
            with tf.name_scope('p6'):
                p6 = tf.nn.softmax(tf.matmul(x, w0_9 * gate_9)
                                   + b0
                                   + tf.matmul(hidden_3, w0_3) * gate_3
                                   + tf.matmul(hidden_4, w0_4) * gate_4
                                   + tf.matmul(hidden_5, w0_5) * gate_5
                                   + tf.matmul(hidden_6, w0_6) * gate_6
                                   + tf.matmul(hidden_7, w0_7) * gate_7
            ...
            with tf.name_scope('p7'):
                p7 = tf.nn.softmax(tf.matmul(x, w0_9 * gate_9)
                                   + b0
                                   + tf.matmul(hidden_2, w0_2) * gate_2
                                   + tf.matmul(hidden_3, w0_3) * gate_3
                                   + tf.matmul(hidden_4, w0_4) * gate_4
                                   + tf.matmul(hidden_5, w0_5) * gate_5
                                   + tf.matmul(hidden_6, w0_6) * gate_6
            ...
            with tf.name_scope('p8'):
                p8 = tf.nn.softmax(tf.matmul(x, w0_9 * gate_9)
                                   + b0
                                   + tf.matmul(hidden_1, w0) * gate_1
                                   + tf.matmul(hidden_2, w0_2) * gate_2
                                   + tf.matmul(hidden_3, w0_3) * gate_3
                                   + tf.matmul(hidden_4, w0_4) * gate_4
                                   + tf.matmul(hidden_5, w0_5) * gate_5
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1209_nonliner_10layer", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1209_nonliner_10layer_4"
