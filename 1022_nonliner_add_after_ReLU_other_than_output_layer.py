...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('layer7'):
            ...
            with tf.name_scope('w7_9'):
                ...
                # w7_9 = tf.Variable(tf.truncated_normal(shape=[input_size, num_units7], mean=0.0, stddev=0))
        ...
        with tf.name_scope('layer6'):
            ...
            with tf.name_scope('w6_9'):
                ...
                # w6_9 = tf.Variable(tf.truncated_normal(shape=[input_size, num_units6], mean=0.0, stddev=0))
        ...
        with tf.name_scope('layer5'):
            ...
            with tf.name_scope('w5_9'):
                ...
                # w5_9 = tf.Variable(tf.truncated_normal(shape=[input_size, num_units5], mean=0.0, stddev=0))
        ...
        with tf.name_scope('layer4'):
            ...
            with tf.name_scope('w4_9'):
                ...
                # w4_9 = tf.Variable(tf.truncated_normal(shape=[input_size, num_units4], mean=0.0, stddev=0))
        ...
        with tf.name_scope('layer3'):
            ...
            with tf.name_scope('w3_9'):
                ...
                # w3_9 = tf.Variable(tf.truncated_normal(shape=[input_size, num_units3], mean=0.0, stddev=0))
        ...
        with tf.name_scope('layer2'):
            ...
            with tf.name_scope('w2_9'):
                ...
                # w2_9 = tf.Variable(tf.truncated_normal(shape=[input_size, num_units2], mean=0.0, stddev=0))
            with tf.name_scope('b2'):
        ...
        with tf.name_scope('layer1_fully_connected'):
            ...
            with tf.name_scope('w1_9'):
                ...
                # w1_9 = tf.Variable(tf.truncated_normal(shape=[input_size, num_units1], mean=0.0, stddev=0))
        ...
        with tf.name_scope('layer0_output_fully_connected'):
            ...
            with tf.name_scope('w0_9'):
                ...
                # w0_9 = tf.Variable(tf.truncated_normal(shape=[input_size, 10], mean=0.0, stddev=0))
        ...
        with tf.name_scope('feed_forword'):
            ...
            with tf.name_scope('state1'):
                ...
                with tf.name_scope('p1'):
                    p1 = tf.nn.softmax(tf.matmul(hidden1_1_drop, w0) + b0)
            ...
            with tf.name_scope('state2'):
                ...
                with tf.name_scope('hidden2_1'):
                    hidden2_1 = tf.nn.relu(tf.matmul(hidden2_2_drop, w1) + b1) + tf.matmul(x, w1_9)
                with tf.name_scope('hidden2_1_drop'):
                    hidden2_1_drop = tf.nn.dropout(hidden2_1, keep_prob)
                with tf.name_scope('p2'):
                    p2 = tf.nn.softmax(b0 + tf.matmul(hidden2_1_drop, w0))
        ...
        with tf.name_scope('optimizer'):
            ...
            with tf.name_scope('train_step1'):
                train_step1 = tf.train.AdamOptimizer(0.0001).minimize(loss1, var_list=[w0, w1_9])
            with tf.name_scope('train_step2'):
                train_step2 = tf.train.AdamOptimizer(0.0001).minimize(loss2, var_list=[w1, w2_9])
            with tf.name_scope('train_step3'):
                train_step3 = tf.train.AdamOptimizer(0.0001).minimize(loss3, var_list=[w2, w3_9])
            with tf.name_scope('train_step4'):
                train_step4 = tf.train.AdamOptimizer(0.0001).minimize(loss4, var_list=[w3, w4_9])
            with tf.name_scope('train_step5'):
                train_step5 = tf.train.AdamOptimizer(0.0001).minimize(loss5, var_list=[w4, w5_9])
            with tf.name_scope('train_step6'):
                train_step6 = tf.train.AdamOptimizer(0.0001).minimize(loss6, var_list=[w5, w6_9])
            with tf.name_scope('train_step7'):
                train_step7 = tf.train.AdamOptimizer(0.0001).minimize(loss7, var_list=[w6, w7_9])
            with tf.name_scope('train_step8'):
                train_step8 = tf.train.AdamOptimizer(0.0001).minimize(loss8, var_list=[w7, w8])
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1022_nonliner_add_after_ReLU_other_than_output_layer", sess.graph)
