...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('layer0'):
            ...
            with tf.name_scope('shortcut_weight'):
                ...
                w0_3 = tf.Variable(
                    tf.truncated_normal(shape=[num_units3, output_size], mean=0.0, stddev=1 / num_units3))
                w0_2 = tf.Variable(
                    tf.truncated_normal(shape=[num_units2, output_size], mean=0.0, stddev=1 / num_units2))
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1204_MNIST_shortcut_MLP_5layer_valid_acc", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "saver_1204_MNIST_shortcut_MLP_5layer_valid_acc_4"
    ...
    for i in range(loop_len):
        ...
        tmp_acc = shortcut_mlp.sess.run(shortcut_mlp.accuracy,
