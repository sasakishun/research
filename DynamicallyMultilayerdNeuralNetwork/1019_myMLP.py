    ...
    def prepare_model(self):
        ...
        with tf.name_scope('layer1_fully_connected'):
            ...
            with tf.name_scope('w1'):
                # w1 = tf.random_uniform(shape=[input_size, num_units1], minval=-0.0,maxval=0.0,dtype=tf.float32)
                w1 = tf.Variable(tf.truncated_normal(shape=[input_size, num_units1], mean=0.0, stddev=0.1))
        ...
        with tf.name_scope('layer2_fully_connected'):
            ...
            with tf.name_scope('w2'):
                ...
                w2 = tf.Variable(tf.truncated_normal(shape=[num_units1, num_units2], mean=0.0, stddev=0.1))
