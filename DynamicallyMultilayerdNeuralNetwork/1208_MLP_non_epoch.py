...
class layer:
            ...
            with tf.name_scope('w6'):
                w6 = tf.Variable(
                    tf.random_uniform(shape=[num_units7, num_units6],
                                      ...
                                      dtype=tf.float32))
                # w6 = tf.Variable(
                # tf.truncated_normal(shape=[num_units7, num_units6], mean=0.0, stddev=math.sqrt(2 / num_units7)))
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1208_MLP_non_epoch", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1208_MLP_non_epoch_"
