...
class layer:
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1109_compare/nonliner", sess.graph)
...
if __name__ == '__main__':
    ...
    mlp = MLP.layer()
    shortcut_MLP = __import__("1105_MNIST_shortcutMLP")
