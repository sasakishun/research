...
class layer:
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1101_notMNIST_MLP", sess.graph)
...
if __name__ == '__main__':
    ...
    for i in range(loop_len):
        ...
        if i % 100 == 0:
            ...
            print('Step: %d, Loss(tr): %f, Accuracy: %f' % (i, loss_val, acc_val))
            ...
            print('Step: %d, Loss(te): %f, Accuracy: %f' % (i, loss_val, acc_val))
