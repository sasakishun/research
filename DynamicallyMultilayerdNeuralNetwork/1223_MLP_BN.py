...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('train_step0'):
            ...
            with tf.control_dependencies(update_ops):
                ...
                train_step3 = tf.train.AdamOptimizer().minimize(loss3)#, var_list=[w8, b8, w7, b7, w6, b6, w5, b5, w0_5, b0_5])
                train_step4 = tf.train.AdamOptimizer().minimize(loss4)#, var_list=[w0_4, b0_4, w4, b4])
                train_step5 = tf.train.AdamOptimizer().minimize(loss5)#, var_list=[w0_3, b0_3, w3, b3])
                train_step6 = tf.train.AdamOptimizer().minimize(loss6)#, var_list=[w0_2, b0_2, w2, b2])
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/session_log/saver_1223_MLP_BN", sess.graph)
...
if __name__ == '__main__':
    ...
    drop_out_rate = 1.0
    session_name = "./session_log/saver_1223_MLP_BN_4"
    training = True
    testing = False
