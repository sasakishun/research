...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('feed_forword'):
            ...
            """
            p0 = tf.nn.softmax(tf.matmul(hidden_3, w0_3) + b0_3)
            p1 = tf.nn.softmax(tf.matmul(hidden_3, w0_3) + b0_3)
            p2 = tf.nn.softmax(tf.matmul(hidden_3, w0_3) + b0_3)
            p3 = tf.nn.softmax(tf.matmul(hidden_3, w0_3) + b0_3)

            p4 = tf.nn.softmax(tf.matmul(hidden_3, w0_3) + b0_3)
            p5 = tf.nn.softmax(tf.matmul(hidden_3, w0_3) + b0_3)
            p6 = tf.nn.softmax(tf.matmul(hidden_3, w0_3) + b0_3)
            """
            p0 = tf.nn.softmax(tf.matmul(hidden_8, w0_8) + b0_8)
            p1 = tf.nn.softmax(tf.matmul(hidden_7, w0_7) + b0_7)
            p2 = tf.nn.softmax(tf.matmul(hidden_6, w0_6) + b0_6)
            p3 = tf.nn.softmax(tf.matmul(hidden_5, w0_5) + b0_5)
            p4 = tf.nn.softmax(tf.matmul(hidden_4, w0_4) + b0_4)
            p5 = tf.nn.softmax(tf.matmul(hidden_3, w0_3) + b0_3)
            p6 = tf.nn.softmax(tf.matmul(hidden_2, w0_2) + b0_2)
            p0 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_4, w0_4) + b0_4, training=training))
            p1 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_4, w0_4) + b0_4, training=training))
            p2 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_4, w0_4) + b0_4, training=training))
            p3 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_4, w0_4) + b0_4, training=training))
            p4 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_4, w0_4) + b0_4, training=training))
            p5 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_3, w0_3) + b0_3, training=training))
            p6 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_2, w0_2) + b0_2, training=training))
            """
        ...
        with tf.name_scope('train_step0'):
            ...
            with tf.control_dependencies(update_ops):
                ...
                """
                """
                train_step0 = tf.train.AdamOptimizer().minimize(loss0, var_list=[w0_8, b0_8, w8, b8])
                train_step1 = tf.train.AdamOptimizer().minimize(loss1, var_list=[w0_7, b0_7, w7, b7])
                train_step2 = tf.train.AdamOptimizer().minimize(loss2, var_list=[w0_6, b0_6, w6, b6])
                train_step3 = tf.train.AdamOptimizer().minimize(loss3, var_list=[w0_5, b0_5, w5, b5])
                train_step4 = tf.train.AdamOptimizer().minimize(loss4, var_list=[w0_4, b0_4, w4, b4])
                train_step5 = tf.train.AdamOptimizer().minimize(loss5, var_list=[w0_3, b0_3, w3, b3])
                train_step6 = tf.train.AdamOptimizer().minimize(loss6, var_list=[w0_2, b0_2, w2, b2])
                """
                train_step0 = tf.train.AdamOptimizer().minimize(loss0, var_list=[w8, b8, w7, b7, w6, b6, w5, b5, w4, b4, w3, b3, w0_3, b0_3])
                train_step1 = tf.train.AdamOptimizer().minimize(loss1, var_list=[w7, b7, w6, b6, w5, b5, w4, b4, w3, b3, w0_3, b0_3])
                train_step2 = tf.train.AdamOptimizer().minimize(loss2, var_list=[w6, b6, w5, b5, w4, b4, w3, b3, w0_3, b0_3])
                train_step3 = tf.train.AdamOptimizer().minimize(loss3, var_list=[w5, b5, w4, b4, w3, b3, w0_3, b0_3])
                train_step4 = tf.train.AdamOptimizer().minimize(loss4, var_list=[w4, b4, w3, b3, w0_3, b0_3])
                train_step5 = tf.train.AdamOptimizer().minimize(loss5, var_list=[w3, b3, w0_3, b0_3])
                train_step6 = tf.train.AdamOptimizer().minimize(loss6, var_list=[w0_3, b0_3])
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1224_MLP_weight_fixed_under_to_top_9layer", sess.graph)
...
if __name__ == '__main__':
    ...
    drop_out_rate = 1.0
    session_name = "./session_log/saver_1224_MLP_weight_fixed_under_to_top_9layer_"
    training = True
    testing = False
