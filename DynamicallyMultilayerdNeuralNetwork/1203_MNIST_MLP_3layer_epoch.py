...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('layer0'):
            with tf.name_scope('w0'):
                w0 = tf.Variable(tf.truncated_normal(shape=[num_units1, output_size], mean=0.0, stddev=math.sqrt(1 / num_units1)))
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1203_MNIST_MLP_3layer_epoch", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1203_MNIST_MLP_3layer_epoch_5"
