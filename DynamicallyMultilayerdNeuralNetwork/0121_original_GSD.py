...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('feed_forword'):
            ...
            """
            """
            hidden_8 = tf.nn.sigmoid(tf.matmul(x, w8) + b8)
            hidden_7 = tf.nn.sigmoid(tf.matmul(hidden_8, w7) + b7)
            hidden_6 = tf.nn.sigmoid(tf.matmul(hidden_7, w6) + b6)
            hidden_5 = tf.nn.sigmoid(tf.matmul(hidden_6, w5) + b5)
            hidden_4 = tf.nn.sigmoid(tf.matmul(hidden_5, w4) + b4)
            hidden_3 = tf.nn.sigmoid(tf.matmul(hidden_4, w3) + b3)
            hidden_2 = tf.nn.sigmoid(tf.matmul(hidden_3, w2) + b2)
            """
        ...
        with tf.name_scope('train_step0'):
            ...
            with tf.control_dependencies(update_ops):
                ...
                train_step0 = tf.train.AdamOptimizer().minimize(loss0,
                                                                var_list=[w8, b8, w0_8, b0_8])
                train_step1 = tf.train.AdamOptimizer().minimize(loss1,
                                                                var_list=[w7, b7, w0_7, b0_7])
                train_step2 = tf.train.AdamOptimizer().minimize(loss2,
                                                                var_list=[w6, b6, w0_6, b0_6])
                train_step3 = tf.train.AdamOptimizer().minimize(loss3,
                                                                var_list=[w5, b5, w0_5, b0_5])
                train_step4 = tf.train.AdamOptimizer().minimize(loss4,
                                                                var_list=[w4, b4, w0_4, b0_4])
                train_step5 = tf.train.AdamOptimizer().minimize(loss5,
                                                                var_list=[w3, b3, w0_3, b0_3])
                train_step6 = tf.train.AdamOptimizer().minimize(loss6,
                                                                var_list=[w2, b2, w0_2, b0_2])

                train_step0_under = tf.train.AdamOptimizer().minimize(loss0, var_list=[w0_8, b0_8])
                train_step1_under = tf.train.AdamOptimizer().minimize(loss1, var_list=[w0_7, b0_7])
                train_step2_under = tf.train.AdamOptimizer().minimize(loss2, var_list=[w0_6, b0_6])
                train_step3_under = tf.train.AdamOptimizer().minimize(loss3, var_list=[w0_5, b0_5])
                train_step4_under = tf.train.AdamOptimizer().minimize(loss4, var_list=[w0_4, b0_4])
                train_step5_under = tf.train.AdamOptimizer().minimize(loss5, var_list=[w0_3, b0_3])
                train_step6_under = tf.train.AdamOptimizer().minimize(loss6, var_list=[w0_2, b0_2])

                train_step0_upper = tf.train.AdamOptimizer().minimize(loss0)
                train_step1_upper = tf.train.AdamOptimizer().minimize(loss1)
                train_step2_upper = tf.train.AdamOptimizer().minimize(loss2)
                train_step3_upper = tf.train.AdamOptimizer().minimize(loss3)
                train_step4_upper = tf.train.AdamOptimizer().minimize(loss4)
                train_step5_upper = tf.train.AdamOptimizer().minimize(loss5)
                train_step6_upper = tf.train.AdamOptimizer().minimize(loss6)
                """
                train_step0 = tf.train.GradientDescentOptimizer(0.1).minimize(loss0,
                                                                var_list=[w8, b8, w0_8, b0_8])
                ...
                train_step2 = tf.train.GradientDescentOptimizer(0.1).minimize(loss2,
                                                                var_list=[w6, b6, w0_6, b0_6])
                train_step3 = tf.train.GradientDescentOptimizer(0.1).minimize(loss3,
                                                                var_list=[w5, b5, w0_5, b0_5])
                train_step4 = tf.train.GradientDescentOptimizer(0.1).minimize(loss4,
                                                                var_list=[w4, b4, w0_4, b0_4])
                train_step5 = tf.train.GradientDescentOptimizer(0.1).minimize(loss5,
                                                                var_list=[w3, b3, w0_3, b0_3])
                train_step6 = tf.train.GradientDescentOptimizer(0.1).minimize(loss6,
                                                                var_list=[w2, b2, w0_2, b0_2])

                train_step0_under = tf.train.GradientDescentOptimizer(0.1).minimize(loss0, var_list=[w0_8, b0_8])
                train_step1_under = tf.train.GradientDescentOptimizer(0.1).minimize(loss1, var_list=[w0_7, b0_7])
                train_step2_under = tf.train.GradientDescentOptimizer(0.1).minimize(loss2, var_list=[w0_6, b0_6])
                train_step3_under = tf.train.GradientDescentOptimizer(0.1).minimize(loss3, var_list=[w0_5, b0_5])
                train_step4_under = tf.train.GradientDescentOptimizer(0.1).minimize(loss4, var_list=[w0_4, b0_4])
                train_step5_under = tf.train.GradientDescentOptimizer(0.1).minimize(loss5, var_list=[w0_3, b0_3])
                train_step6_under = tf.train.GradientDescentOptimizer(0.1).minimize(loss6, var_list=[w0_2, b0_2])

                train_step0_upper = tf.train.GradientDescentOptimizer(0.1).minimize(loss0)
                train_step1_upper = tf.train.GradientDescentOptimizer(0.1).minimize(loss1)
                train_step2_upper = tf.train.GradientDescentOptimizer(0.1).minimize(loss2)
                train_step3_upper = tf.train.GradientDescentOptimizer(0.1).minimize(loss3)
                train_step4_upper = tf.train.GradientDescentOptimizer(0.1).minimize(loss4)
                train_step5_upper = tf.train.GradientDescentOptimizer(0.1).minimize(loss5)
                train_step6_upper = tf.train.GradientDescentOptimizer(0.1).minimize(loss6)
...
if __name__ == '__main__':
    ...
    session_name_layer = "./session_log/saver" + path.splitext(path.basename(__file__))[0] + str(session_number)+"layer"
    print(session_name)
    training = True
    testing = False
    ...
    for j in range(start, layer_num):
        ...
        loss_list.append(loss_val_valid)
        summary, loss_val, acc_val = nn.sess.run(
            [nn.summary, nn.loss[j], nn.accuracy[j]],
            feed_dict={nn.x: test_data, nn.t: test_labels, nn.keep_prob: 1.0, nn.training: testing,
                       nn.input_batch_size: len(test_labels)})
        ...
        if acc_val_valid > final_acc_valid:
            ...
            print("------test__end------")
        if loss_val_valid*1.01 < final_loss_valid:
            # if loss_val_valid < final_loss_valid*1.01:
    ...
    summary, loss_val_train, acc_val_train = nn.sess.run(
        ...
        feed_dict={nn.x: train_test_data, nn.t: train_test_labels, nn.keep_prob: 1.0, nn.training: testing,
                   nn.input_batch_size: len(train_test_labels)})
    print('Step: %d, Loss(tr): %f, Accuracy: %f' % (loop_count-1, loss_val_train, acc_val_train))
    summary, loss_val_valid, acc_val_valid = nn.sess.run(
        [nn.summary, nn.loss[final_loss_layer], nn.accuracy[final_loss_layer]],
        feed_dict={nn.x: valid_data, nn.t: valid_labels, nn.keep_prob: 1.0, nn.training: testing,
                   nn.input_batch_size: len(valid_labels)})
    print('Step: %d, Loss(va): %f, Accuracy: %f' % (loop_count-1, loss_val_valid, acc_val_valid))
    summary, loss_val, acc_val = nn.sess.run(
        [nn.summary, nn.loss[final_loss_layer], nn.accuracy[final_loss_layer]],
        feed_dict={nn.x: test_data, nn.t: test_labels, nn.keep_prob: 1.0, nn.training: testing,
                   nn.input_batch_size: len(test_labels)})
    print('Step: %d, Loss(te): %f, Accuracy: %f' % (loop_count-1, loss_val, acc_val))
    loop_count += 1
    best_loss = 10000.
    for i in range(loop_len):
        early_stopping_num = 30
    ...
    for i in range(early_stopping_num):
        #graph_y[final_loss_layer + 1][loop_count + i] = None
    ...
    np.save("GSD_y", graph_y)
    if dataset_flag == 0:
        np.save("GSD_mnist", graph_y)
    if dataset_flag == 1:
        np.save("GSD_fashion", graph_y)
    if dataset_flag == 2:
        np.save("GSD_cifar10", graph_y)
    if dataset_flag == 3:
        np.save("GSD_cifar100", graph_y)
