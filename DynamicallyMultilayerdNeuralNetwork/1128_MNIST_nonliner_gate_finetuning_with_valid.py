...
class layer:
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1128_MNIST_nonliner_gate_finetuning_with_valid", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1128_MNIST_nonliner_fine_tuning_with_valid_"
