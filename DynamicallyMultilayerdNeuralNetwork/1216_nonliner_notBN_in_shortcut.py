...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('feed_forword'):
            ...
            with tf.name_scope('p0'):
                hidden_1_8 = tf.nn.relu((tf.layers.batch_normalization(hidden_8 * gate_8, training=training) + b1))
                p0 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_8, w0), training=training) + b0)
            with tf.name_scope('p1'):
                hidden_1_7 = tf.nn.relu((tf.layers.batch_normalization(hidden_8 * gate_8 + hidden_7 * gate_7,
                                                                       training=training) / 2 + b1))
                p1 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_7, w0), training=training) + b0)
            with tf.name_scope('p2'):
                hidden_1_6 = tf.nn.relu(
                    (tf.layers.batch_normalization(hidden_8 * gate_8 + hidden_7 * gate_7 + hidden_6 * gate_6,
                                                   training=training) / 3 + b1))
                p2 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_6, w0), training=training) + b0)
            with tf.name_scope('p3'):
                hidden_1_5 = tf.nn.relu((tf.layers.batch_normalization(
                    hidden_8 * gate_8 + hidden_7 * gate_7 + hidden_6 * gate_6 + hidden_5 * gate_5,
                    training=training) / 4 + b1))
                p3 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_1_5, w0), training=training) + b0)
            with tf.name_scope('p4'):
                hidden_1_4 = tf.nn.relu(
                    (tf.layers.batch_normalization(
                        hidden_8 * gate_8 + hidden_7 * gate_7 + hidden_6 * gate_6 + hidden_5 * gate_5 + hidden_4 * gate_4,
            ...
            with tf.name_scope('p5'):
                hidden_1_3 = tf.nn.relu(
                    (tf.layers.batch_normalization(
                        hidden_8 * gate_8 + hidden_7 * gate_7 + hidden_6 * gate_6 + hidden_5 * gate_5 + hidden_4 * gate_4 + hidden_3 * gate_3,
            ...
            with tf.name_scope('p6'):
                hidden_1_2 = tf.nn.relu((tf.layers.batch_normalization(
                    hidden_8 * gate_8 + hidden_7 * gate_7 + hidden_6 * gate_6 + hidden_5 * gate_5 + hidden_4 * gate_4 + hidden_3 * gate_3 + hidden_2 * gate_2,
        ...
        with tf.name_scope('train_step0'):
            ...
            with tf.control_dependencies(update_ops):
                train_step0 = tf.train.AdamOptimizer().minimize(loss0, var_list=[w0, b0, b1, w8, b8])#, gate_8])
                train_step1 = tf.train.AdamOptimizer().minimize(loss1, var_list=[w0, b0, b1, w7, b7])#, gate_7, gate_8])
                train_step2 = tf.train.AdamOptimizer().minimize(loss2,
                                                                var_list=[w0, b0, b1, w6, b6])#, gate_6, gate_7, gate_8])
                train_step3 = tf.train.AdamOptimizer().minimize(loss3,
                                                                var_list=[w0, b0, b1, w5, b5])#, gate_5, gate_6, gate_7, gate_8])
                train_step4 = tf.train.AdamOptimizer().minimize(loss4,
                                                                var_list=[w0, b0, b1, w4, b4])#, gate_4, gate_5, gate_6, gate_7, gate_8])
                train_step5 = tf.train.AdamOptimizer().minimize(loss5,
                                                                var_list=[w0, b0, b1, w3, b3])#, gate_3, gate_4, gate_5, gate_6, gate_7, gate_8])
                train_step6 = tf.train.AdamOptimizer().minimize(loss6,
                                                                var_list=[w0, b0, b1, w2, b2, gate_2, gate_3, gate_4, gate_5, gate_6, gate_7, gate_8])
                """
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1216_nonliner_notBN_in_shortcut", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1216_nonliner_notBN_in_shortcut_2"
    training = True
    testing = False
