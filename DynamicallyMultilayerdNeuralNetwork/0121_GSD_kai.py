...
if __name__ == '__main__':
    ...
    session_name_layer = "./session_log/saver" + path.splitext(path.basename(__file__))[0] + str(
        session_number) + "layer"
    print(session_name)
    training = True
    testing = False
    ...
    """
    result is written in 0206_log_GSD.txt
    """
    f = open("0206_log_GSD.txt", 'a')
