...
class layer:
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1213_nonliner_kill_under_weight", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1213_nonliner_kill_under_weight_2"
    training = True
    testing = False
