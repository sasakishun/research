...
class layer:
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1204_MNIST_MLP_5layer_valid_acc", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1204_MNIST_MLP_5layer_valid_acc_5"
    ...
    for j in range(4, 5):
        ...
        for i in range(loop_len):
            ...
            tmp_acc = nn.sess.run(nn.accuracy[j], feed_dict={nn.x: valid_data, nn.t: valid_labels,
