...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('feed_forword'):
            ...
            with tf.name_scope('p6'):
                ...
                hidden_gate_tuning = tf.nn.relu((tf.layers.batch_normalization(
                    hidden_8 + hidden_7 + hidden_6 + hidden_5 + hidden_4 + hidden_3 + hidden_2,
                    training=training) / 7 + b1))
                p7 = tf.nn.softmax(tf.layers.batch_normalization(tf.matmul(hidden_gate_tuning, w0)) + b0)
        ...
        with tf.name_scope('optimizer'):
            ...
            with tf.name_scope('loss4'):
                ...
                loss7 = -tf.reduce_sum(t * tf.log(tf.clip_by_value(p7, 1e-10, 1.0))) / input_batch_size
            """
        ...
        with tf.name_scope('train_step0'):
            ...
            with tf.control_dependencies(update_ops):
                ...
                train_step7 = tf.train.AdamOptimizer().minimize(loss6, var_list=[w0, b0, b1])
                # train_step7 = tf.train.AdamOptimizer().minimize(loss7, var_list=[gate_8, gate_7, gate_6, gate_5, gate_4, gate_3, gate_2])
                """
        ...
        train_step = [train_step0, train_step1, train_step2, train_step3, train_step4,
                      train_step5, train_step6, train_step7]
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1218_nonliner_gate_learn_last", sess.graph)
...
if __name__ == '__main__':
    ...
    drop_out_rate = 1.0
    session_name = "./session_log/saver_1218_nonliner_gate_learn_last_"
    training = True
    testing = False
