...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('layer1'):
            with tf.name_scope('w1'):
                w1 = tf.Variable(
                    tf.truncated_normal(shape=[input_size, num_units1], mean=0.0, stddev=math.sqrt(1 / input_size)))
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1203_shortcut_MLP_3layer_epoch", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1203_shortcut_MLP_3layer_epoch_5"
