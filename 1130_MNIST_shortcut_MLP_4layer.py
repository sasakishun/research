...
class layer:
        ...
        with tf.name_scope('feed_forword'):
            with tf.name_scope('state8'):
                ...
                with tf.name_scope('p8'):
                    p8 = tf.nn.softmax(tf.matmul(x, w0_3) + b0
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1130_MNIST_shortcut_MLP_4layer", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "saver_1130_shortcut_MLP_4layer_10000_4"
