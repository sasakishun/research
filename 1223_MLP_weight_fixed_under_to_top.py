    ...
    def prepare_model(self):
        ...
        with tf.name_scope('layer1'):
            ...
            with tf.name_scope('b1'):
                ...
                b1 = tf.Variable(tf.constant(bias_ReLU, shape=[num_units1]))
        ...
        with tf.name_scope('feed_forword'):
            ...
            """
            p0 = tf.nn.softmax(tf.matmul(hidden_4, w0_4) + b0_4)
            p1 = tf.nn.softmax(tf.matmul(hidden_4, w0_4) + b0_4)
            p2 = tf.nn.softmax(tf.matmul(hidden_4, w0_4) + b0_4)
            p3 = tf.nn.softmax(tf.matmul(hidden_4, w0_4) + b0_4)
            p4 = tf.nn.softmax(tf.matmul(hidden_4, w0_4) + b0_4)
            p5 = tf.nn.softmax(tf.matmul(hidden_4, w0_4) + b0_4)
        ...
        with tf.name_scope('train_step0'):
            ...
            with tf.control_dependencies(update_ops):
                ...
                train_step6 = tf.train.AdamOptimizer().minimize(loss6, var_list=[w0_2, b0_2, w2, b2])
                """
                train_step0 = tf.train.AdamOptimizer().minimize(loss0)#, var_list=[w8, b8, w7, b7, w6, b6, w5, b5, w4, b4, w0_4, b0_4])
                train_step1 = tf.train.AdamOptimizer().minimize(loss1)#, var_list=[w7, b7, w6, b6, w5, b5, w4, b4, w0_4, b0_4])
                train_step2 = tf.train.AdamOptimizer().minimize(loss2)#, var_list=[w6, b6, w5, b5, w4, b4, w0_4, b0_4])
                train_step3 = tf.train.AdamOptimizer().minimize(loss3)#, var_list=[w5, b5, w4, b4, w0_4, b0_4])
                train_step4 = tf.train.AdamOptimizer().minimize(loss4)#, var_list=[w4, b4, w0_4, b0_4])
                train_step5 = tf.train.AdamOptimizer().minimize(loss5)#, var_list=[w0_4, b0_4])
                train_step6 = tf.train.AdamOptimizer().minimize(loss6)#, var_list=[w0_8, b0_8, w8, b8])
