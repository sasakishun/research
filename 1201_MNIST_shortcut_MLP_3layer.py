...
class layer:
        ...
        with tf.name_scope('feed_forword'):
            with tf.name_scope('state8'):
                with tf.name_scope('hidden8_1'):
                    hidden8_1 = tf.nn.relu(tf.matmul(x, w1) + b1)
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1201_MNIST_shortcut_MLP_3layer", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "saver_1201_shortcut_MLP_3layer_10000_6"
