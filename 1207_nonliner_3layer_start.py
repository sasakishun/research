...
class layer:
    ...
    def prepare_model(self):
        ...
        with tf.name_scope('layer0'):
            ...
            with tf.name_scope('b0'):
                ...
                gate_6 = tf.Variable(tf.constant(1.0, shape=[num_units6, output_size]))
        ...
        with tf.name_scope('feed_forword'):
            ...
            with tf.name_scope('state1'):
                ...
                with tf.name_scope('p1'):
                    p1 = tf.nn.softmax(tf.matmul(hidden1_8_drop, (w0_8 * tf.sigmoid(gate_8)))
                                       + b0 + tf.matmul(x, w0_9 * tf.sigmoid(gate_9)))
            ...
            with tf.name_scope('state2'):
                ...
                with tf.name_scope('p2'):
                    p2 = tf.nn.softmax(b0 + tf.matmul(x, w0_9 * tf.sigmoid(gate_9))
                                       + tf.matmul(hidden2_7_drop, w0_7 * tf.sigmoid(gate_7))
            ...
            with tf.name_scope('state3'):
                ...
                with tf.name_scope('p3'):
                    p3 = tf.nn.softmax(b0 + tf.matmul(x, w0_9 * tf.sigmoid(gate_9))
            ...
            with tf.name_scope('state4'):
                ...
                with tf.name_scope('p4'):
                    p4 = tf.nn.softmax(b0 + tf.matmul(x, w0_9 * tf.sigmoid(gate_9))
        ...
        with tf.name_scope('optimizer'):
            ...
            with tf.name_scope('train_step2'):
                train_step2 = tf.train.AdamOptimizer().minimize(loss2,
                                                                var_list=[b0, w0_7, w7, b7, w8, b8, gate_8, gate_9])
            with tf.name_scope('train_step3'):
                train_step3 = tf.train.AdamOptimizer().minimize(loss3,
                                                                var_list=[b0, w0_6, w6, b6, w7, b7, w8, b8, gate_7, gate_8, gate_9])
            with tf.name_scope('train_step4'):
                train_step4 = tf.train.AdamOptimizer().minimize(loss4)
            # Adam
            """
    ...
    def prepare_session(self):
        ...
        writer = tf.summary.FileWriter("./log/1207_nonliner_3layer_start", sess.graph)
...
if __name__ == '__main__':
    ...
    session_name = "./session_log/saver_1207_nonliner_3layer_start_"
